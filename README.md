Grundsätzliches:
Verändert die Dropdown-Städteübersicht nach individiuellen Einstellungen auf Basis eines Rasters
Einstellungen auf dem Knopf "Grid" zwischen Stadtname und Rohstoffen
Standardeinstellung auf 10 Stadtgruppen angepasst und ggf für kleine Bildschirme zu groß
Dio-Tool Grafiken bleiben erhalten


Einstellungen:

Spalten:
Die Anzahl an horizontalen Spalten
Spalte_1 | Spalte_2 | Spalte_3 | etc

Spaltenbreite:
Die Breite der einzelen Spalten in px

Höhe:
Die Höhe der gesamten Übersicht in px
...
Standardeinstellungen sind so aufgeteilt:
Alle | Gruppe 1 | Gruppe 3 | Gruppe 6 | Gruppe 9
Alle | Gruppe 1 | Gruppe 3 | Gruppe 6 | Gruppe 9
Alle | Gruppe 1 | Gruppe 4 | Gruppe 7 | Gruppe 10
...
Gruppe 1 | Gruppe 2 | Gruppe 5 | Keine Gruppe

Speichern:
Speichert die aktuell eingetragenen Werte und aktualisiert die Übersicht

Standard:
Setzt alles auf die Standardwerte zurück
Bei versehentlichem Klicken auf speichern Klicken, die eingetragen Werte werden nicht überschrieben, wenn nicht zwischendurch auf schließen gedrückt wurde
